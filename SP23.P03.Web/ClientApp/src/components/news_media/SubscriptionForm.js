...
const SubscriptionForm = () => {
	...
	return (
		<form onSubmit={handleSubmit} className="max-w-lg mx-auto mt-4">
			<p className="block mb-2 font-bold text-gray-700">
				Subscribe today to receive flash sales, promotions and special offers by
				email.
			</p>
			...
			<p className="mt-2 text-gray-600">
				Stay up-to-date with our latest flash sales, promotions, and special
				offers.
			</p>
		</form>
	);
