    ...
    <div class=" grid-cols-12 gap-6 sm:gap-4 md:gap-6 lg:gap-10 xl:gap-14 w-80 h-96 my-10 px-2 grey-glassmorphism">
        <div id="menu" class="bg-white/10 col-span-3 rounded-lg p-4 ">
            ...
            <a href="#" class="flex flex-col space-y-2 md:space-y-0 md:flex-row mb-5 items-center md:space-x-2 hover:bg-black/10 group transition duration-150 ease-linear rounded-lg group w-full py-3 px-2">
                ...
                <div>
                    <p class="font-medium group-hover:text-black-400 leading-4">User Name</p>
            ...
            <div className="flex flex-col space-y-2 my-5">
                <a href="#" class="hover:bg-white/10 transition duration-150 ease-linear rounded-lg py-3 px-2 group">
                    <div class="flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                        ...
                        <div>
                            <p class="font-bold text-base lg:text-lg text-black-200 leading-4 group-hover:text-black-400">Dashboard</p>
                        <p class="text-black-400 text-sm hidden md:block">Data overview</p>
                        </div>
                ...
                <a href="#" class="hover:bg-white/10 transition duration-150 ease-linear rounded-lg py-3 px-2 group">
                    <div class="relative flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                        ...
                        <div>
                            <p class="font-bold text-base lg:text-lg text-black-200 leading-4 group-hover:text-black-400">Tickets</p>
                        <p class="text-black-400 text-sm hidden md:block">Manage Bookings</p>
                        </div>
                ...
                <a href="#" class="hover:bg-white/10 transition duration-150 ease-linear rounded-lg py-3 px-2 group">
                    <div class="flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                        ...
                        <div>
                        <p class="font-bold text-base lg:text-lg text-black-200 leading-4 group-hover:text-black-400">
Settings</p>
                        <p class="text-black-400 text-sm hidden md:block">Edit settings</p>
                        </div>
