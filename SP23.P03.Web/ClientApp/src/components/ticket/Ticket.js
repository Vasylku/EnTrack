...
const handleDownload = () => {
	...
	const ticket = new JsPDF("portrait", "pt", "a4");
	ticket.html(document.querySelector("#ticket")).then(() => {
		...
		<div className="flex w-full min-h-screen justify-center items-center bg-[#202124]">
			...
			>
				...
				<div className="flex items-center justify-between px-6 py-4 bg-gray-200">
					...
					<button className="flex items-center justify-center px-4 py-2 font-bold   text-white bg-blue-500 rounded-md hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue active:bg-blue-800">
